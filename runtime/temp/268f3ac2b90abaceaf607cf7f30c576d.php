<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\Web\thinkphp5SSO\public/../app/auth\view\authenticate\login.html";i:1516625249;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<script type="application/javascript">
    var iframeurl = 'http://localhost:9000/commonhtml';
        ...
        $('.btn').on('click', function(event) {
            $.post('/dologin',$("form").serialize(), function (result) {
                ...
                if(result.status == 'success'){
                    console.log('success');
                    window.frames[0].postMessage(result.token,iframeurl);
